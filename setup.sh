...
echo -e "[ ${green}INFO${NC} ] Persiapan Install"
apt install git curl -y >/dev/null 2>&1
echo -e "[ ${green}INFO${NC} ] BERES SIAP DI INSTALL"
sleep 2
echo -ne "[ ${green}INFO${NC} ] Request Perizinan : "

PERMISSION
if [ -f /home/needupdate ]; then
red "Your script need to update first !"
exit 0
elif [ "$res" = "DI IJINKAN LURR..." ]; then
green "DI IJINKAN LURR!"
else
...
echo ""
wget -q https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/SSH/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/WEBSOCKET/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/OPENVPN/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/MENU/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/sreyaeve/multi/main/FILE/version  )
